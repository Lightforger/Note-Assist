...
NA.initUi = function () {
    ...
    container.innerHTML =
      ...
      '#noteAssist_singleNoteSection, #noteAssist_eyedropperSection, #noteAssist_saveAllNotesSection { border-top: 2px solid black; position:relative; padding-top:3px; }' +
      ...
      '' +
      '<div id="noteAssist_eyedropperSection"></div>' + //content dynamically generated by the script
      '' +
      '' +
      '<div id="noteAssist_saveAllNotesSection">' +
      '<input type="button" id="noteAssist_saveAllNotes" value="Save all non-ghost notes"         title="Save all changes notes, except ghost notes (red striped background)"/> ' +
      '' +
      '</div>' +
      '' +
      '' +
    ...
    document.getElementById('noteAssist_saveAllNotes').addEventListener('click', NA.saveAllNotes, false);
